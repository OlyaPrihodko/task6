...
public final class ConnectionPool {
    ...
    public void initPoolData() throws ConnectionPoolException { Locale.setDefault(Locale.ENGLISH);
...
//	logger.log(Level.ERROR, "Statement isn't closed.");
    ...
    private class PooledConnection implements Connection {
        ...
        public PooledConnection(Connection c) throws SQLException {
            this.connection = c; this.connection.setAutoCommit(true);
        ...
        @Override        public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException { return connection.createStatement(resultSetType,
